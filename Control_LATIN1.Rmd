...
importe_total <- gsub("[[:alpha:]]", "", ticket1.tidy$importe_total)
ticket1.tidy$importe_total <-importe_total

importe_total <- gsub(" ", "", ticket1.tidy$importe_total)
ticket1.tidy$importe_total <- importe_total
