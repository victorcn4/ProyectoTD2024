...
todos_productos$Precios <- gsub(",","X",todos_productos$Precios)

todos_productos$Precios <- gsub("[[:punct:]]","",todos_productos$Precios)

todos_productos$Precios <- gsub("X",".",todos_productos$Precios)

todos_productos$Precios <- gsub("^[0-9]+[^,]","",todos_productos$Precios)
