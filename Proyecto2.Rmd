...
author: "Laura Beltran Pellicer, Victor Cardama Noguera, Mara Ferrús Castells, Jorge García Pozuelo, Sandra López Llorens"
date: "2024-05-14"
output:
...
ggplot(productos_filtrados, aes(x = Productos)) + 
  geom_bar(fill = "skyblue", color = "black") + 
  labs(title = "Número de veces que que se compra cada producto (con más de 2 ocurrencias)", 
       x = "Producto", 
       y = "Número de veces")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```
En el gráfico anterior observamos, ordenado de menos apariciones a más, los días en los que más compras se hace. Podemos concluir que los días en los que más se compra son los martes y los sábados con 4 compras cada día. Por lo contrario, existen tres días con 1 sola compra, domingo, miércoles y viernes. Si miramos más allá son resultados con sentido.
En primer lugar, los domingos en España es festivo por lo que cierran los establecimientos. En cuanto al miércoles y viernes, si nos fijamos, los días que más se compra son directamente previos o posteriores a los que menos, por lo que una vez hecha la compra, pocas veces vas a necesitar el dia siguiente. 
...
3. ¿Categoría y producto más comprados en general? 
...
4. ¿Cuál es el producto que más se ha comprado?

El producto que más se ha comprado es "Queso Lonchas Cabra"

5. ¿Cuál es el día de la semana más habitual en que se han producido los tickets registrados?
...
7. ¿En que Mercadona se han comprado más productos?

8. ¿Cual ha sido el Mercadona con más productos comprados? ¿Y en el que más compras se han hecho?
