...
En nuestro proyecto de análisis de tickets de Mercadona, hemos hecho uso de varias librerías en el lenguaje de programación R para llevar a cabo diferentes tareas de procesamiento, análisis y visualización de datos. Vamos a explicarla una por una:
